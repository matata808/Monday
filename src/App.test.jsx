...
describe("App", () => {
  it("renders the professional dashboard with boards, task metadata, subtasks, and mail", async () => {
    render(<App />);
    ...
    expect(screen.getByText("Open registration mail")).toBeInTheDocument();
